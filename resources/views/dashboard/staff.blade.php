        ...
        fetch(`{{ route('petty-cash.index') }}/${id}`, {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    let settleSigUrl = pc.settlement_signature_url || (pc.settlement_signature_path ? (pc.settlement_signature_path.startsWith('data:image/') || pc.settlement_signature_path.startsWith('http') ? pc.settlement_signature_path : `/${pc.settlement_signature_path.replace(/^\/?(public\/)?/, '')}`) : '');
